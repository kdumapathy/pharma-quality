...
INSERT INTO l1_raw.raw_lims_spec_limit VALUES
    -- Assay AC
    ('ing-201','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h201','LIM-001','ITEM-001','SPEC-001','AC','Between','95.0','105.0','100.0',NULL,'%','as-is','Release',NULL,NULL,NULL,NULL,NULL,'TRUE','ICH Q6A','2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE),
    -- Dissolution AC
    ('ing-204','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h204','LIM-004','ITEM-002','SPEC-001','AC','NLT','80.0',NULL,NULL,NULL,'% (Q)','as-is','Release',NULL,NULL,NULL,NULL,NULL,'TRUE','USP','2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE),
    -- Content Uniformity AC
    ('ing-205','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h205','LIM-005','ITEM-003','SPEC-001','AC','Between','85.0','115.0','100.0',NULL,'%','as-is','Release',NULL,NULL,NULL,NULL,NULL,'TRUE','USP <905>','2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE),
    -- Impurity A AC
    ('ing-206','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h206','LIM-006','ITEM-004','SPEC-001','AC','NMT',NULL,'0.15',NULL,NULL,'%','as-is','Release',NULL,NULL,NULL,NULL,NULL,'TRUE','ICH Q3B','2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE),
    -- Hardness AC
    ('ing-208','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h208','LIM-008','ITEM-005','SPEC-001','AC','Between','5.0','15.0','10.0',NULL,'kp','as-is','Release',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE),
    -- Description (text limit)
    ('ing-209','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h209','LIM-009','ITEM-006','SPEC-001','AC',NULL,NULL,NULL,NULL,'White to off-white film-coated tablets','N/A','as-is','Release',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE),
    -- Assay Stability AC (T6M 40C/75%RH)
    ('ing-210','LIMS','BATCH-2026-001',CURRENT_TIMESTAMP(),'h210','LIM-010','ITEM-001','SPEC-001','AC','Between','90.0','110.0','100.0',NULL,'%','as-is','Stability','T6M','40C75RH',NULL,NULL,NULL,'TRUE','ICH Q1A','2024-12-01','2025-01-10',CURRENT_DATE,CURRENT_DATE);
